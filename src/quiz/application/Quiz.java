...
public class Quiz extends JFrame implements ActionListener{
    ...
    Quiz(String username){
        ...
        question = new JLabel( );
        question.setBounds(130,450,800,30);
        ...
        opt1.setBounds(135,520,700,30);
        opt1.setBackground(Color.WHITE);
        opt1.setFont(new Font("Dialog",Font.PLAIN,20));
        add(opt1);
        
        opt2 = new JRadioButton ( );
        opt2.setBounds(135,560,700,30);
        opt2.setBackground(Color.WHITE);
        opt2.setFont(new Font("Dialog",Font.PLAIN,20));
        add(opt2);
        
        opt3 = new JRadioButton ( );
        opt3.setBounds(135,600,700,30);
        opt3.setBackground(Color.WHITE);
        opt3.setFont(new Font("Dialog",Font.PLAIN,20));
        add(opt3);
        
        opt4 = new JRadioButton ( );
        opt4.setBounds(135,640,700,30);
    ...
    public void actionPerformed(ActionEvent ae){
        if(ae.getSource()== next){
            ...
            if(count == 2 || count == 4 ||count ==6 ||count == 8||coujnt==9){
    ...
    public void paint (Graphics g){
        super.paint(g);
        String time = "Time left "+ timer + " second ";
